...
try {
    ...
    $stmt = $conn->prepare("SELECT rut FROM electores WHERE rut = :rut");
    ...
    $stmt = $conn->prepare("INSERT INTO electores (nombre, rut, correo, region, comuna, candidato, informacion) 
